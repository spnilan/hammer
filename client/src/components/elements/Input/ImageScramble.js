...
const DraggableImage = ({ slice, onMoveItem }) => {
    ...
    const { row, column, id, imageUrl, squareSize } = slice;
...
const ImageScramble = ({imageUrl, squareSize, completed, onComplete }) => {
    ...
    }, [correctOrder, completed, onComplete])
